...
| **UI-01** | Keyboard Input Buffering (Line Discipline) | High | 4h | **In-Progress** |
| **CORE-04** | PIT (Programmable Interval Timer) Setup | High | 4h | **Todo** |
| **UI-02** | Simple Command Parser (`help`, `clear`) | Medium | 6h | **Todo** |
| **DRV-03** | Circular Buffers for Data I/O | Medium | 3h | **Todo** |
| **MEM-01** | Physical Memory Manager (PMM) - Bitmap | High | 10h | **Todo** |
...
| **SCHED-01** | Basic Round-Robin CPU Scheduler | High | 10h | **Todo** |
| **SYS-01** | System Call Dispatcher (int 0x80) | High | 8h | **Todo** |
...
| **CONC-01** | Synchronization Primitives (Spinlocks/Mutex) | Medium | 8h | **Todo** |
...
### Phase 3: Filesystem & Execution
Implementing a Virtual File System (VFS) to support files and eventually loading user-mode programs.